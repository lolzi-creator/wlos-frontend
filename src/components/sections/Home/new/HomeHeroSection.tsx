...
import '../../../../styles/modules/home/new/HomeHeroSection.css';
...
export const HomeHeroSection: React.FC = () => {
    ...
    // Set a fixed future date for the countdown (July 30, 2024 for example)
    const targetDate = useRef(new Date('2024-07-30T00:00:00'));
            ...
            <div className="hero-content">
                <div className={`hero-text-container ${isLoaded ? 'loaded' : ''}`}>
                    ...
                    <div className="countdown-container">
                        <div className="countdown-title">WLOS TOKEN LAUNCH IN</div>
